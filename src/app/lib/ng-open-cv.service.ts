...
export class NgOpenCVService {
	...
	onCameraStartedCallback!: (a: any, b: any) => any;
	...
	// addFileInputHandler(fileInputId: any, canvasId: any) {
	...
	// startCamera(resolution: any, callback: any, videoId: any) {
	...
	//   if (!video) {
	//     // Create a new video element if the specified ID doesn't exist
	//     video = document.createElement('video');
	//     // Set the ID for the newly created video element
	//     video.id = 'videoId';
	...
	getContours(src: any, width: any, height: any) {
